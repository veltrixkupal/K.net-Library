...
function Library:NewWindow(ConfigWindow)
    ...
    Icon = "https://www.roblox.com/Thumbs/Asset.ashx?width=420&height=420&assetId=128948495957267",
    Watermark = {
        Text = "Watermark!",
        ...
        Padding = 10,
        Icon = true,
        IconImage = "https://www.roblox.com/Thumbs/Asset.ashx?width=420&height=420&assetId=128948495957267",
        OnGui = true
    }
}, ConfigWindow or {})
...
if ConfigWindow.Watermark then
    ...
    WatermarkFrame.Name = "Kryzen.net"
...
G2L["2"]["Image"] = [[https://www.roblox.com/Thumbs/Asset.ashx?width=420&height=420&assetId=128948495957267]];
...
Icon_3.Image = "rbxassetid://128948495957267"
...
local AllLayouts = 0
	...
	Choose_2.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    ...
    UIGradient.Color = ColorSequence.new { ColorSequenceKeypoint.new(0.00, Color3.fromRGB(24, 24, 25)), ColorSequenceKeypoint.new(0.52, Color3.fromRGB(255, 255, 255)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(24, 24, 25)) }
    ...
    UIGradientttt_2.Color = ColorSequence.new { ColorSequenceKeypoint.new(0.00, Color3.fromRGB(24, 24, 25)), ColorSequenceKeypoint.new(0.52, Color3.fromRGB(255, 255, 255)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(24, 24, 25)) }
    ...
    function ToggleFunc:Set(Boolean)
        ...
        if Boolean then
            Library:TweenInstance(ToggleCheck, 0.3, "BackgroundColor3", Color3.fromRGB(255, 255, 255))
            Library:TweenInstance(Check, 0.3, "Position", OnPos)
            Library:TweenInstance(Check, 0.3, "BackgroundColor3", Color3.fromRGB(0, 0, 0))
        else
...
Callback = function()
	...
	for _, v in next, Real_List:GetChildren() do
		if v:IsA("Frame") and v:FindFirstChild("Title") then
			...
			function DropFunc:Add(v)  
				...
				UIGradient_3.Color = ColorSequence.new { ColorSequenceKeypoint.new(0.00, Color3.fromRGB(0, 0, 0)), ColorSequenceKeypoint.new(0.51, Color3.fromRGB(255, 255, 255)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0, 0, 0)) }  
    ...
    UIGradientttt.Color = ColorSequence.new { ColorSequenceKeypoint.new(0.00, Color3.fromRGB(24, 24, 25)), ColorSequenceKeypoint.new(0.52, Color3.fromRGB(255, 255, 255)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(24, 24, 25)) }
